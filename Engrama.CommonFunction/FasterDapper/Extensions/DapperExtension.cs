...
namespace CommonFuncion.FasterDapper.Extensions
{
    ...
    {
        private static Dictionary<string, DbType> DbTypeToCSharpTypes = new Dictionary<string, DbType>()
        {
        ...
        private static readonly Dictionary<string, SqlDbType> SqlDbTypeToCSharpTypes = new Dictionary<string, SqlDbType>()
        {
